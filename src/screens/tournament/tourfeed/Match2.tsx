...
const TourFeedMatch2: React.FC<{ tournament: any }> = ({ tournament }) => {
  // Use semi-final 2 for this screen
  const currentMatchup = tournament.rounds?.semiFinal2;
            ...
            renderItem={({ item: match, index }) => {
              ...
              return (
                <MatchCard
                  ...
                  teamStartIndex={2} // Use teams 3 & 4
                  isReadOnly={true}
                />
              );
            }}
