...
const TVDisplay: React.FC<TVDisplayProps> = ({ className = "" }) => {
  ...
  if (!isClient) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br from-gray-900 to-yellow-900 ${className}`}
      >
        <div className="flex items-center justify-center h-full">
          <div className="text-yellow-100 text-8xl">Loading...</div>
        </div>
      </div>
    );
  }
  ...
  if (!tournamentData) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br from-gray-900 to-yellow-900 flex items-center justify-center ${className}`}
      >
        <div className="bg-gray-800 p-8 rounded-lg shadow-lg text-center border border-yellow-500">
          <h2 className="text-8xl font-bold mb-4 text-yellow-100">
            No Tournament Data
          </h2>
          ...
          <div className="mt-4">
            <span className="ml-2 text-2xl text-gray-300">Disconnected</span>
          </div>
        </div>
      </div>
    );
            ...
            .map((round, index) => {
              ...
              return (
                <div
                  ...
                  className="bg-gray-800 bg-opacity-90 backdrop-blur-sm rounded-lg p-2 md:p-4 text-white shadow-lg border border-yellow-500"
                >
                  ...
                  (tournamentData.rounds.find(
                    ...
                    <div className="flex items-center justify-center mb-2 md:mb-4">
                      ...
                      <div className="text-yellow-300 font-bold mx-2 md:mx-4 text-2xl md:text-4xl">
                        0 - 0
                      </div>
                      <div className="text-white font-bold text-lg md:text-2xl">
                        TBD
                    ...
                    <div className="flex items-center justify-center mb-2 md:mb-4">
                      ...
                      <div className="text-yellow-300 font-bold mx-3 md:mx-6 text-2xl md:text-4xl">
                  ...
                  <h4 className="text-white bg-yellow-600 p-2 md:p-3 font-bold text-center mb-2 md:mb-4 text-lg md:text-2xl">
                        ...
                        >
                          ...
                          <div
                            className={`text-base md:text-xl font-bold mb-1 md:mb-2 text-center ${
                              hasStarted ? "text-yellow-300" : "text-white"
                            }`}
                          >
                          ...
                          <div className="flex items-center justify-center">
                            ...
                            <div className="flex items-center justify-end flex-1 pr-2 md:pr-4">
                              <div className="text-white text-base md:text-xl font-bold mr-2 md:mr-4">
                                {round.roundName === "final" &&
                                (tournamentData.rounds.find(
                                  (r) => r.roundName === "semiFinal1"
                                )?.isCompleted !== true ||
                              ...
                              <div className="text-yellow-300 text-base md:text-xl font-bold">
                                {match.team1?.score || 0}
                              </div>
                            </div>

                            <div className="text-white text-base md:text-xl font-bold mx-2 md:mx-4">
                              vs
                            </div>
                            ...
                            <div className="flex items-center justify-start flex-1 pl-2 md:pl-4">
                              ...
                              <div className="text-white text-base md:text-xl font-bold ml-2 md:ml-4">
                                {round.roundName === "final" &&
                                (tournamentData.rounds.find(
                                  (r) => r.roundName === "semiFinal1"
                                )?.isCompleted !== true ||
