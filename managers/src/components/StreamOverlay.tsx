...
const StreamOverlay: React.FC<StreamOverlayProps> = ({ className = "" }) => {
  ...
  if (!isClient) {
    return (
      ...
      >
        <div className="text-white text-2xl md:text-4xl">Loading...</div>
      </div>
    );
  }
  ...
  return (
    <div
      className={`w-full max-w-full md:w-120 h-auto bg-gradient-to-b from-gray-900 via-yellow-900 to-gray-900 overflow-hidden border-2 md:border-4 border-yellow-400 ${className} p-1 md:p-4 mt-3`}
    >
      <div className="flex flex-col h-full space-y-1 overflow-hidden">
        {/* Semifinal 1 Section */}
        {semifinal1 && !hiddenSections.includes("semifinal1") && (
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-1 md:p-3 border border-gray-700 shadow-lg mt-0.5 mb-0.5">
            ...
            <div className="bg-gray-700 rounded-lg p-0.5 md:p-2.5 mb-1 md:mb-3 border border-yellow-500">
              <div className="flex items-center justify-between">
                <div className="text-white text-sm md:text-2xl font-bold text-center flex-1 truncate">
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-center mb-1 md:mb-3">
                      <div className="text-white text-sm md:text-2xl font-bold text-center">
                        M{matchIndex + 1}: {getMatchType(matchIndex)}
                      </div>
                    </div>
                    <div className="flex items-center justify-between">
                      <div className="text-white text-sm md:text-2xl font-semibold text-center flex-1 truncate">
                        {match.team1?.name ||
        ...
        {final && semifinal1?.isCompleted && semifinal2?.isCompleted && (
          <div className="bg-gradient-to-br from-yellow-900 via-yellow-800 to-yellow-900 rounded-lg p-1 md:p-3 border-2 border-yellow-500 shadow-2xl">
            <div className="flex items-center justify-center mb-1 md:mb-3">
              <h2 className="text-lg md:text-2xl font-bold bg-gradient-to-r from-yellow-400 to-yellow-600 text-black px-1 md:px-3 py-0.5 md:py-3 rounded-lg shadow-lg">
                🏆 FINAL
              </h2>
            </div>
            ...
            <div className="space-y-1 md:space-y-3">
              {getLastTwoActiveMatches(final).map((match, index) => {
                ...
                return (
                  ...
                  >
                    <div className="text-white text-sm md:text-2xl font-bold mb-1 md:mb-3 text-center">
                      M{matchIndex + 1}: {getMatchType(matchIndex)}
                    </div>
                    <div className="flex items-center justify-between">
        ...
        {final && (!semifinal1?.isCompleted || !semifinal2?.isCompleted) && (
          <div className="bg-gradient-to-br from-gray-800 to-gray-900 rounded-lg p-1 md:p-3 border border-gray-700 shadow-lg">
            ...
            {/* Placeholder message */}
            <div className="text-center text-gray-400 text-sm md:text-2xl">
