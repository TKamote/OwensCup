...
const TVDisplay: React.FC<TVDisplayProps> = ({ className = "" }) => {
  ...
  if (!isClient) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br from-yellow-100 to-amber-100 ${className}`}
      >
  ...
  if (!tournamentData) {
    return (
      <div
        className={`min-h-screen bg-gradient-to-br from-yellow-100 to-amber-100 flex items-center justify-center ${className}`}
      >
