...
export default function StandbyAnnouncement() {
  ...
  return (
    <div className="min-h-screen flex justify-center p-2 md:p-8">
      <div className="text-center w-11/12 sm:w-10/12 md:w-11/12 max-w-5xl mx-auto pt-4 md:pt-8 bg-gradient-to-br from-yellow-100 to-amber-100 rounded-2xl p-4 md:p-8">
        {/* Tournament Title */}
        ...
        {/* Time Selector */}
        {showTimeSelector && (
          <div className="mb-4 md:mb-8 bg-white bg-opacity-90 p-4 md:p-8 rounded-2xl shadow-2xl border-4 border-yellow-300">
            ...
            <div className="flex justify-center items-center space-x-2 md:space-x-4 mb-3 md:mb-6">
              <select
                ...
                className="text-lg md:text-3xl font-semibold p-2 md:p-4 rounded-xl border-2 border-gray-300 bg-white text-gray-800 focus:border-yellow-500 focus:outline-none"
              >
            ...
            <button
              ...
              className="bg-yellow-500 hover:bg-yellow-600 text-white text-lg md:text-2xl font-bold py-2 md:py-4 px-4 md:px-8 rounded-xl transition-colors duration-200"
            >
              Start Countdown
            </button>
          </div>
        ...
        {!showTimeSelector && (
          <div className="mb-4 md:mb-8">
            {isLive ? (
              ...
              <div className="bg-white bg-opacity-90 p-4 md:p-8 rounded-2xl shadow-2xl border-4 border-yellow-300">
                ...
                <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4 lg:space-x-8 mb-2 md:mb-4">
                  <div className="text-center">
                    <div className="text-4xl md:text-6xl lg:text-8xl font-bold text-yellow-600 bg-yellow-100 rounded-xl p-2 md:p-4 min-w-[80px] md:min-w-[120px]">
                ...
                {/* Scheduled Time */}
                <div className="bg-yellow-100 p-2 md:p-4 rounded-xl">
                ...
                <div className="mt-2 md:mt-4">
                  <button
                    ...
                    className="bg-yellow-500 hover:bg-yellow-600 text-white text-lg md:text-xl font-semibold py-2 px-4 md:px-6 rounded-lg transition-colors duration-200"
                  >
                    Change Time
                  </button>
                </div>
